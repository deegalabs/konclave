...
const TXT = {
  'pt-BR': {
    eyebrow: 'Demo ao vivo do motor de política',
    title: 'Herança / interruptor de vida',
    lead: 'O responsável envia batimentos de "prova de vida". Se ele ficar em silêncio além da janela configurada, mais um período de carência cancelável, o quórum passa a estar autorizado a liberar o cofre para o herdeiro. A liberação é um pagamento comum assinado pelo quórum (reusa o caminho FROST). A novidade é só a política: quem decide que o responsável se foi, e quando.',
    caption: 'Espelho fiel de orchestrator/src/inheritance.rs, rodando no navegador.',
    cfgTitle: 'Política',
    lapse: 'Janela de silêncio (lapso)',
    grace: 'Carência (cancelável)',
    heir: 'Endereço do herdeiro',
    days: 'dias',
    heartbeat: 'Enviar prova de vida (batimento)',
    heartbeatHint: 'Zera o relógio: o silêncio volta a zero.',
    simTitle: 'Simular a passagem do tempo',
    simHint: 'Arraste ou pule dias para ver o interruptor mudar sem esperar.',
    elapsed: 'Silêncio simulado',
    stateActive: 'Ativo',
    statePending: 'Em carência',
    stateReleased: 'Liberável',
    descActive: 'O responsável está presente (batimento recente). Os fundos seguem travados no quórum normal.',
    descPending: 'O responsável passou do lapso, mas a carência ainda corre. Um batimento agora reverte tudo.',
    descReleased: 'Lapso e carência venceram. O quórum já pode propor a liberação ao herdeiro.',
    untilRelease: 'Até ficar liberável',
    untilPending: 'Até entrar em carência',
    now: 'liberável agora',
    authorized: 'Liberação autorizada ao quórum',
    notAuthorized: 'Liberação ainda não autorizada',
    zoneLapse: 'lapso',
    zoneGrace: 'carência',
    zoneReleased: 'liberável',
    hbMark: 'batimento',
    footnote: 'Nada aqui move fundos. É uma visualização da política; a liberação real seria uma proposta de pagamento comum, aprovada pelo quórum, assinada por FROST.',
    back: 'Voltar ao início',
    errLapse: 'A janela de silêncio precisa ser maior que zero.',
    errGrace: 'A carência não pode ser negativa.',
    errHeir: 'É preciso um endereço de herdeiro para armar a herança.',
    unit_d: 'd',
    unit_h: 'h',
    unit_m: 'min',
    unit_s: 's',
  ...
  en: {
    ...
    title: 'Inheritance / dead-man’s-switch',
