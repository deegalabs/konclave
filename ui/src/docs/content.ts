        ...
        items: [
          {
            ...
            en: '**On mainnet, 5 verifiable txids** (`node scripts/verify-proof.mjs` or the /proof page): a 2-of-3 quorum payment (proposed/approved in the app, FROST-signed, shares sealed at rest); a private payroll (one shielded Orchard tx with 3 outputs, each with an encrypted memo, 2-of-3 FROST); a payment reproduced end to end from a freshly created and funded vault; and a **send from a real DKG-generated vault** (three-participant DKG ceremony, key never reconstituted), funded and spent by FROST. Honest note: the quorum payment, payroll, and fresh vault used trusted-dealer; only the DKG-vault send came from a key born by real DKG.',
          },
          {
