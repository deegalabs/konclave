...
- ✅ **On mainnet, five independently verifiable txids** (`node scripts/verify-proof.mjs`, or the
  ...
  ceremony, key **never reconstituted**), then funded and spent by a FROST ceremony. Honest note: the
