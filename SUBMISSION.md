...
- ✅ **On mainnet, five verifiable txids** (`node scripts/verify-proof.mjs`, or the /proof page):
  ...
  payroll and fresh-vault txids used a trusted-dealer vault; the app payment and the DKG-vault send
  used DKG.
...
- 🗺️ **Roadmap:** real-transaction signing in the browser, full on-device share persistence,
