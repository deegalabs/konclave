...
| **A send made from production after the seat-poisoning fix landed** (#399/#515): an ordinary quorum payment, made on the deployed web app at 12:19 UTC on 2026-09-15, three hours after the fix merged. The chain shows a normal shielded V6 transaction and cannot show more. What this entry does NOT claim, because nothing here attests it: the vault's quorum shape, or whether a seat was absent. An earlier version of this row said it was a 2-of-3 signing with one seat offline; that came from the entry's own author and from no record, so it is removed rather than left standing. | `7d6b3dec5a39ebca1c8228304d5c347ab36b7f4283910b7acccd333aed7fc346` | 3,484,231 |
