...
| **A seat absent, and the payment still went through** (#399/#515): a 2-of-3 vault signing with one seat offline - the shape that used to stall, where an unproven claim on the empty seat could be chosen for the threshold set and produce an aggregate no share had made. Signed on production after the fix, first try, no retry. The chain shows an ordinary shielded V6 transaction and cannot show this: what attests it is that the vault has three seats, two devices signed, and the ceremony reached a verifying aggregate on the first attempt. | `7d6b3dec5a39ebca1c8228304d5c347ab36b7f4283910b7acccd333aed7fc346` | 3,484,231 |
