...
**Built and proven (18 verifiable mainnet txids incl. the Ironwood cycle, the first browser-signed broadcast, a cross-device send across separate physical machines, and a phone-signed send; see `docs/PROOF.md`):**
